...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod('vw_education_lite_slider_hide_show') != ''){ ?>
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod( 'vw_education_lite_slider_speed',3000)) ?>"> 
            ...
            <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  <?php if( get_theme_mod('vw_education_lite_slider_title_hide_show',true) != ''){ ?>
                    <h1><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
                  <?php } ?>
                  <?php if( get_theme_mod('vw_education_lite_slider_content_hide_show',true) != ''){ ?>
                  ...
                  <?php } ?>
                  <?php if( get_theme_mod('vw_education_lite_slider_button_hide_show',true) != ''){ ?>
