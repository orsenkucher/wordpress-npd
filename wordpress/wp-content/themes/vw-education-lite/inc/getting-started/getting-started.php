		  		...
		  		<div class="link-customizer">
					...
					<div class="first-row">
						...
						<div class="row-box">
							...
							<div class="row-box2">
								<span class="dashicons dashicons-align-center"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_education_lite_our_courses') ); ?>" target="_blank"><?php esc_html_e('Our Featured Courses','vw-education-lite'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_education_lite_post_settings') ); ?>" target="_blank"><?php esc_html_e('Post settings','vw-education-lite'); ?></a>
							</div>
							 <div class="row-box2">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-welcome-write-blog"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_education_lite_left_right') ); ?>" target="_blank"><?php esc_html_e('General Settings','vw-education-lite'); ?></a>
							</div>
							<div class="row-box2">
