...
function vw_education_lite_customize_register( $wp_customize ) {
	...
	$VWEducationLiteParentPanel = new VW_Education_Lite_WP_Customize_Panel( $wp_customize, 'vw_education_lite_panel_id', array(
		...
		'theme_supports' => '',
		'title' => esc_html__( 'VW Settings', 'vw-education-lite' ),
		'priority' => 10,
	));

	//Layouts
	$wp_customize->add_section( 'vw_education_lite_left_right', array(
    	'title'      => esc_html__( 'General Settings', 'vw-education-lite' ),
		'priority'   => null,
	...
	$wp_customize->add_setting( 'vw_education_lite_slider_excerpt_number', array(
		'default'              => 30,
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_education_lite_sanitize_number_range'
	) );
	...
	$wp_customize->add_setting( 'vw_education_lite_slider_speed', array(
		'default'  => 3000,
		'sanitize_callback'	=> 'vw_education_lite_sanitize_float'
	) );
	$wp_customize->add_control( 'vw_education_lite_slider_speed', array(
		'label' => esc_html__('Slider Transition Speed','vw-education-lite'),
		'section' => 'vw_education_lite_slidersettings',
		'type'  => 'number',
	) );
	...
	$wp_customize->add_setting( 'vw_education_lite_blog_pagination_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_education_lite_switch_sanitization'
    ));  
    $wp_customize->add_control( new VW_Education_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_education_lite_blog_pagination_hide_show',array(
      'label' => esc_html__( 'Show / Hide Blog Pagination','vw-education-lite' ),
      'section' => 'vw_education_lite_post_settings'
    )));

	$wp_customize->add_setting( 'vw_education_lite_blog_pagination_type', array(
        'default'			=> 'blog-page-numbers',
        'sanitize_callback'	=> 'vw_education_lite_sanitize_choices'
    ));
    $wp_customize->add_control( 'vw_education_lite_blog_pagination_type', array(
        'section' => 'vw_education_lite_post_settings',
        'type' => 'select',
        'label' => __( 'Blog Pagination', 'vw-education-lite' ),
        'choices'		=> array(
            'blog-page-numbers'  => __( 'Numeric', 'vw-education-lite' ),
            'next-prev' => __( 'Older Posts/Newer Posts', 'vw-education-lite' ),
    )));
    ...
    $wp_customize->add_setting('vw_education_lite_button_text',array(
		'default'=> esc_html__( 'Read More', 'vw-education-lite' ),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	...
	$wp_customize->add_section( 'vw_education_lite_single_blog_settings', array(
		'title' => __( 'Single Post Settings', 'vw-education-lite' ),
		'panel' => 'blog_post_parent_panel',
	));
    ...
    $wp_customize->add_control( new VW_Education_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_education_lite_toggle_tags', array(
		...
		'section' => 'vw_education_lite_single_blog_settings'
    )));

	$wp_customize->add_setting( 'vw_education_lite_single_blog_post_navigation_show_hide',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_education_lite_switch_sanitization'
	));
    $wp_customize->add_control( new VW_Education_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_education_lite_single_blog_post_navigation_show_hide', array(
		'label' => esc_html__( 'Post Navigation','vw-education-lite' ),
		'section' => 'vw_education_lite_single_blog_settings'
    )));

	//navigation text
	$wp_customize->add_setting('vw_education_lite_single_blog_prev_navigation_text',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_education_lite_single_blog_prev_navigation_text',array(
		'label'	=> __('Post Navigation Text','vw-education-lite'),
		'input_attrs' => array(
            'placeholder' => __( 'PREVIOUS PAGE', 'vw-education-lite' ),
        ),
		'section'=> 'vw_education_lite_single_blog_settings',
		'type'=> 'text'
	));

	$wp_customize->add_setting('vw_education_lite_single_blog_next_navigation_text',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_education_lite_single_blog_next_navigation_text',array(
		'label'	=> __('Post Navigation Text','vw-education-lite'),
		'input_attrs' => array(
            'placeholder' => __( 'NEXT PAGE', 'vw-education-lite' ),
        ),
		'section'=> 'vw_education_lite_single_blog_settings',
		'type'=> 'text'
	));
	...
	$wp_customize->add_section('vw_education_lite_woocommerce_section', array(
		'title'    => __('WooCommerce Layout', 'vw-education-lite'),
		'priority' => null,
		'panel'    => 'woocommerce',
	));
    ...
    $wp_customize->add_control( new VW_Education_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_education_lite_woocommerce_shop_page_sidebar',array(
		...
		'section' => 'vw_education_lite_woocommerce_section'
    )));
	...
	//Products per page
    $wp_customize->add_setting('vw_education_lite_products_per_page',array(
		'default'=> 9,
		'sanitize_callback'	=> 'vw_education_lite_sanitize_float'
	));
	$wp_customize->add_control('vw_education_lite_products_per_page',array(
		'label'	=> __('Products Per Page','vw-education-lite'),
		'description' => __('Display on shop page','vw-education-lite'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
    ...
    //Products per row
    $wp_customize->add_setting('vw_education_lite_products_per_row',array(
		'default'=> 3,
		'sanitize_callback'	=> 'vw_education_lite_sanitize_choices'
	));
	$wp_customize->add_control('vw_education_lite_products_per_row',array(
		'label'	=> __('Products Per Row','vw-education-lite'),
		'description' => __('Display on shop page','vw-education-lite'),
		'choices' => array(
            2 => 2,
			3 => 3,
	...
	//Products padding
	$wp_customize->add_setting('vw_education_lite_products_padding_top_bottom',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_education_lite_products_padding_top_bottom',array(
		'label'	=> __('Products Padding Top Bottom','vw-education-lite'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-education-lite'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-education-lite' ),
        ),
	...
	$wp_customize->add_setting('vw_education_lite_products_padding_left_right',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_education_lite_products_padding_left_right',array(
		'label'	=> __('Products Padding Left Right','vw-education-lite'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-education-lite'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-education-lite' ),
        ),
	...
	//Products box shadow
	$wp_customize->add_setting( 'vw_education_lite_products_box_shadow', array(
		'default'              => '',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_education_lite_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_education_lite_products_box_shadow', array(
		'label'       => esc_html__( 'Products Box Shadow','vw-education-lite' ),
		'section'     => 'vw_education_lite_woocommerce_section',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
    ...
    $wp_customize->add_setting( 'vw_education_lite_products_border_radius', array(
		'default'              => '',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_education_lite_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_education_lite_products_border_radius', array(
		'label'       => esc_html__( 'Products Border Radius','vw-education-lite' ),
		'section'     => 'vw_education_lite_woocommerce_section',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
...
final class VW_Education_Lite_Customize {
	...
	public function sections( $manager ) {
		...
		// Register sections.
		$manager->add_section(new VW_Education_Lite_Customize_Section_Pro($manager,'vw_education_lite_upgrade_pro_link',array(
			'priority'	=> 1,
		...
		$manager->add_section(new VW_Education_Lite_Customize_Section_Pro($manager,'vw_education_lite_get_started_link',array(
			'priority'	=> 1,
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'vw-education-lite-customize-controls', trailingslashit( esc_url(get_template_directory_uri()) ) . '/js/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'vw-education-lite-customize-controls', trailingslashit( esc_url(get_template_directory_uri()) ) . '/css/customize-controls.css' );
	}
}
