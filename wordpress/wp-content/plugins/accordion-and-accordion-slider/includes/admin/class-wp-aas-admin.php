...
class Wp_Aas_Admin {
	...
	function wp_aas_save_metabox_value( $post_id ) {
		...
		$image_size 				= isset($_POST[$prefix.'image_size'])				? wp_aas_slashes_deep($_POST[$prefix.'image_size']) 				: 'large';
	...
	function wp_aas_post_columns_data( $column, $post_id ) {
	    ...
	    switch ($column) {
	    	case 'wp_aas_shortcode':	    		
					echo '<div class="wp-aas-shortcode-preview wpos-copy-clipboard">[aas_slider id="'.$post_id.'"]</div>';				
	    		break;
