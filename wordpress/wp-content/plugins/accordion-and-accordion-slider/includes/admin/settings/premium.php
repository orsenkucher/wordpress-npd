...
<div class="wrap">
	...
	<h2><?php _e( 'Accordion and Accordion Slider with ', 'accordion-and-accordion-slider' ); ?><span class="wpos-epb"><?php _e( 'Essential Plugin Bundle', 'accordion-and-accordion-slider' ); ?></span></h2><br />	
		...
		<div id="post-body" class="metabox-holder columns-2">
				...
				<table class="wpos-plugin-pricing-table">
				    ...
				    <thead>
				    	<tr>
				    		...
				    		<th>
				    			...
				    			<a href="<?php echo WP_AAS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Accordion-Slider&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a>
				    		</th>	    		
				    	</tr>
				    </thead>
				    ...
				    <tfoot>
				    	<tr>
							...
							<a href="<?php echo WP_AAS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Accordion-Slider&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a></td>
				    	</tr>
				    </tfoot>
				   <tbody>
						<tr>
			...
			<div id="postbox-container-1" class="postbox-container wpos-sidebar">
				<div class="wpos-epb-wrap">
					...
					<ul>
						<li><b>40+ Utility Plugins</b> including <span><?php echo WP_AAS_NAME; ?> premium </span> version.</li>
					...
					<a class="button-yellow button-orange" style="margin-bottom:0px;" href="<?php echo WP_AAS_SITE_LINK; ?>/essential-bundle/?utm_source=WP&utm_medium=Accordion-Slider&utm_campaign=EPB-Upgrade-PRO" target="_blank">Buy Now</a>
				</div>
