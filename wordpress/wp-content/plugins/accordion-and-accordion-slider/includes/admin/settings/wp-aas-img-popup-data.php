	...
	<form method="post" class="wp-aas-attachment-form">
		...
		<table class="form-table">
			...
			<tr class="wp-aas-pro-feature">
				<th>
					<?php _e('Caption ', 'accordion-and-accordion-slider'); ?><span class="wp-aas-pro-tag"><?php _e('PRO','accordion-and-accordion-slider');?></span>
				</th>
				<td>
					...
					<span class="description"><?php _e('Enter image caption.', 'accordion-and-accordion-slider'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'accordion-and-accordion-slider'), WP_AAS_PLUGIN_LINK); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<span class="description"><?php _e('Enter image link. e.g https://www.essentialplugin.com', 'accordion-and-accordion-slider'); ?></span>
				</td>
			</tr>
